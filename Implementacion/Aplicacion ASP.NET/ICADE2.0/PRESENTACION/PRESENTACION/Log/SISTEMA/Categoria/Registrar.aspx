<%@ Page Title="" Language="C#" MasterPageFile="~/PRESENTACION/PaginasMaestras/Log/MenuBody/AdministradorGCA.master" AutoEventWireup="true" CodeBehind="Registrar.aspx.cs" Inherits="PRESENTACION.PRESENTACION.Log.SISTEMA.Categoria.Registrar" %>
                    ...
                    <tr>
                        <td style="text-align: left">
                            <asp:Label ID="Label7" runat="server" 
                                ...
                                Text="Registrar Categoria"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" style="text-align: left">
                                        <asp:Label ID="Label1" runat="server" 
                                            style="font-family: Calibri; font-size: large; color: #1D1D1D;" Text="Profesion"></asp:Label>
                                        <br />
