<%@ Page Title="" Language="C#" MasterPageFile="~/PRESENTACION/PaginasMaestras/Log/MenuBody/AdministradorGCA.master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="PRESENTACION.PRESENTACION.Log.SISTEMA.Categoria.Editar" %>
                    ...
                    <tr>
                        <td style="text-align: left">
                            <asp:Label ID="Label0" runat="server" 
                                ...
                                Text="Editar categoria"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" style="text-align: left">
                            <table border="0" width="100%">
                                <tr>
                                    <td>
                            <asp:Button ID="Button1_actualizarprofesion" runat="server" CssClass="boton" Text="Editar profesion" OnClick="Button1_actualizarprofesion_Click" />
                                    </td>
