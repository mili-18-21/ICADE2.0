<%@ Page Title="" Language="C#" MasterPageFile="~/PRESENTACION/PaginasMaestras/NLog/MenuHead/MenuHead.Master" AutoEventWireup="true" CodeBehind="Administrador.aspx.cs" Inherits="PRESENTACION.PRESENTACION.NLog.SISTEMA.Administrador" %>
                                        ...
                                        <table style="width:100%">
                                            <tr>
                                                <td style="text-align: right">
                                                    <asp:Button ID="Button1" runat="server" BackColor="#8EBC00" 
                                                                                    BorderColor="#8EBC00" BorderStyle="Dotted" 
                                                        style="font-family: Calibri; font-size: large; color: #FFFFFF" 
                                                        Text="Registrate" Width="151px" OnClick="Button1_Click" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
